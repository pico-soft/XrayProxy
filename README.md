...
Если нужна **фиксированная версия**, замени `v1.0` на нужный тег релиза.

Пример:

```bash
curl -fsSL https://github.com/pico-soft/XrayProxy/releases/download/v1.0/xrayproxy.zip -o ~/xrayproxy.zip
cd ~
unzip -o xrayproxy.zip
bash xrayproxy/install.sh
```
